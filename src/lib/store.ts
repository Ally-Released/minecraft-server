...
const SURVIVAL_RANKS: Rank[] = [
  {
    ...
    price: 100,
    rarity: "uncommon",
    tagline: "Kickstart your survival journey with essential commands, 4 homes and Diamond Kit.",
    stats: [
      { icon: "chestplate", label: "Kit Perk", value: "Diamond Kit" },
      { icon: "coin", label: "Eco Balance", value: "5k" },
    ...
    extras: [
      { icon: "chest", label: "Armour Kit", value: "Full Diamond" },
      { icon: "coin", label: "Ingame Money", value: "5,000" },
      { icon: "home", label: "Max Homes", value: "4" },
    ],
  },
  {
    id: "elite",
    ...
    price: 350,
    rarity: "rare",
    tagline: "Return on death with /back, portable workbench, 6 homes and 20k economy balance.",
    stats: [
      { icon: "chestplate", label: "Kit Perk", value: "Elite Kit" },
      { icon: "coin", label: "Eco Balance", value: "20k" },
      { icon: "home", label: "Homes", value: "6" },
    ],
    commands: [
      { cmd: "/back", label: "Teleport to previous death/location", icon: "arrow" },
      { cmd: "/feed", label: "Refill hunger bar instantly", icon: "feed" },
      { cmd: "/hat", label: "Wear held block/item as a hat", icon: "helmet" },
      { cmd: "/workbench", label: "Portable 3x3 crafting workbench", icon: "crafting" },
    ],
    extras: [
      { icon: "chest", label: "Armour Kit", value: "Elite Diamond" },
      { icon: "coin", label: "Ingame Money", value: "20,000" },
      { icon: "home", label: "Max Homes", value: "6" },
    ],
  },
  {
    id: "premium",
    ...
    rarity: "epic",
    badge: "Best value",
    tagline: "Portable enderchest, on-the-go item repair, 10 homes and 80k economy balance.",
    stats: [
      { icon: "chestplate", label: "Kit Perk", value: "Premium Kit" },
      { icon: "coin", label: "Eco Balance", value: "80k" },
      { icon: "home", label: "Homes", value: "10" },
    ],
    commands: [
      { cmd: "/back", label: "Teleport to previous location", icon: "arrow" },
      { cmd: "/enderchest", label: "Access Ender Chest anywhere", icon: "enderchest" },
      { cmd: "/feed", label: "Refill hunger bar instantly", icon: "feed" },
      { cmd: "/hat", label: "Wear held block/item as a hat", icon: "helmet" },
    ...
    extras: [
      { icon: "chest", label: "Armour Kit", value: "Enchanted Diamond" },
      { icon: "coin", label: "Ingame Money", value: "80,000" },
      { icon: "home", label: "Max Homes", value: "10" },
    ],
  },
  {
    id: "titan",
    ...
    rarity: "electric",
    badge: "Most popular",
    tagline: "Creative flight, instant healing, portable stations, 20 homes and 150k cash.",
    stats: [
      { icon: "chestplate", label: "Kit Perk", value: "Titan Kit" },
      { icon: "coin", label: "Eco Balance", value: "150k" },
      { icon: "home", label: "Homes", value: "20" },
    ],
    commands: [
      { cmd: "/back", label: "Teleport to previous location", icon: "arrow" },
      { cmd: "/enderchest", label: "Access Ender Chest anywhere", icon: "enderchest" },
    ...
    extras: [
      { icon: "chest", label: "Armour Kit", value: "Netherite Tier" },
      { icon: "coin", label: "Ingame Money", value: "150,000" },
      { icon: "home", label: "Max Homes", value: "20" },
    ],
  },
  {
    id: "royal",
    ...
    rarity: "legendary",
    badge: "Ultimate rank",
    tagline: "The supreme survival package — /nick, /grindstone, god kit, 30 homes & 500k eco.",
    stats: [
      { icon: "chestplate", label: "Kit Perk", value: "Royal God Kit" },
      { icon: "coin", label: "Eco Balance", value: "500k" },
      { icon: "home", label: "Homes", value: "30" },
    ],
    commands: [
      { cmd: "/back", label: "Teleport to previous location", icon: "arrow" },
      { cmd: "/enderchest", label: "Access Ender Chest anywhere", icon: "enderchest" },
    ...
    extras: [
      { icon: "chest", label: "Armour Kit", value: "God Netherite Set" },
      { icon: "coin", label: "Ingame Money", value: "500,000" },
      { icon: "home", label: "Max Homes", value: "30" },
    ],
  },
];
...
const SURVIVAL_COMPARE: CompareRow[] = [
  {
    ...
    icon: "chest",
    group: "Kit & Economy",
    values: ["Diamond Kit", "Elite Kit", "Premium Kit", "Titan Kit", "Royal God Kit"],
  },
  { label: "Homes", icon: "home", group: "Kit & Economy", values: [4, 6, 10, 20, 30] },
  { label: "Eco Balance", icon: "coin", group: "Kit & Economy", values: ["5,000", "20,000", "80,000", "150,000", "500,000"] },
  { label: "Refill hunger (/feed)", icon: "feed", group: "Commands", values: [true, true, true, true, true] },
  ...
  { label: "Portable bench (/workbench)", icon: "crafting", group: "Commands", values: [null, true, true, true, true] },
  { label: "Ender chest (/enderchest)", icon: "enderchest", group: "Commands", values: [null, null, true, true, true] },
  { label: "Repair item (/repair)", icon: "repair", group: "Commands", values: [null, null, true, true, true] },
  { label: "Survival flight (/fly)", icon: "fly", group: "Commands", values: [null, null, null, true, true] },
  { label: "Instant heal (/heal)", icon: "heart", group: "Commands", values: [null, null, null, true, true] },
  { label: "Nickname (/nick)", icon: "nick", group: "Commands", values: [null, null, null, null, true] },
  { label: "Grindstone (/grindstone)", icon: "anvil", group: "Commands", values: [null, null, null, null, true] },
];
