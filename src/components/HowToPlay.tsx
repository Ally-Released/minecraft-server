    ...
    <section id="how-to-play" className="relative z-10 py-28 px-6">
      <div className="max-w-5xl mx-auto">
        ...
        <div ref={stepsRef} className="relative">
          ...
          <div className="absolute left-6 md:left-8 top-0 bottom-0 w-px bg-gradient-to-b from-emerald-accent/40 via-surface-border to-transparent" />
              ...
              return (
                ...
                >
                  ...
                  <div className="relative z-10 shrink-0 w-12 h-12 md:w-16 md:h-16 rounded-2xl bg-surface-1 border border-surface-border flex items-center justify-center">
                    <Icon size={24} className="text-emerald-accent" />
                  </div>
                  ...
                  <div className="flex-1 pb-10">
                    ...
                    {step.hasIp && (
                      <div className="mt-4 inline-flex items-center gap-3 px-5 py-3 rounded-xl bg-surface-1 border border-surface-border">
                        <code className="text-emerald-accent font-mono font-bold">
                          {SERVER_CONFIG.ip}
                        </code>
                        <button
                          onClick={copyIp}
                          className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg bg-emerald-accent/10 text-emerald-accent text-xs font-bold hover:bg-emerald-accent/20 transition-colors"
                    ...
                    {step.isFinal && (
                      <button
                        onClick={copyIp}
                        className="mt-6 px-8 py-3.5 rounded-xl bg-emerald-accent text-surface-0 font-bold text-sm tracking-wide hover:bg-emerald-dim transition-all duration-200 shadow-[0_0_25px_rgba(45,212,160,0.15)] hover:shadow-[0_0_40px_rgba(45,212,160,0.25)] active:scale-[0.98]"
                      >
                        Copy IP &amp; Join →
                      </button>
                    )}
